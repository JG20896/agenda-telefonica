...
if (!isset($_SESSION['pagina_visitada'])) {
    $_SESSION['mensaje'] = mostrarMensaje('success', 
        '🌟 ¡Bienvenido a tu Agenda Telefónica! 📒<br>'
        . '<small>Gestiona tus contactos de forma fácil y segura</small>'
    );
